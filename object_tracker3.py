...
from Custom import FramesToCoordinatesAndDistance
...
#         print("frame_size",frame_size)
        ...
        cv2.putText(frame, f"tracking object {drone_track_id}",(int(frame_size[1]-17*len(f"tracking object {drone_track_id}")), int( 0.05*frame_size[0])),0, 0.75, (255,0,0),1)
        cv2.putText(frame, x_axis,(int(frame_size[1]-17*len(x_axis)), int( 0.15*frame_size[0])),0, 0.75, (255,0,0),1)
        cv2.putText(frame, y_axis,(int(frame_size[1]-17*len(y_axis)), int( 0.25*frame_size[0])),0, 0.75, (255,0,0),1)
        #For connecting both centers
        ...
        FramesToCoordinatesAndDistance(dronePresentCoordinates,[midx,midy],[box_mid_x,box_mid_y],presentAltitude,[frame_size[1],frame_size[0]])
